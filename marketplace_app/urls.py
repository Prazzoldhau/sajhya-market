...
urlpatterns = [
    ...
    path('pharmacy/product/<int:product_id>/', views.pharmacy_product_detail, name='pharmacy-product-detail'),
    path('pharmacy/add-to-cart/<int:product_id>/', views.pharmacy_add_to_cart, name='pharmacy-add-to-cart'),
    path('pharmacy/remove-from-cart/<int:product_id>/', views.pharmacy_remove_from_cart, name='pharmacy-remove-from-cart'),
    path('pharmacy/update-cart/<int:product_id>/', views.pharmacy_update_cart, name='pharmacy-update-cart'),
    path('pharmacy/cart/', views.pharmacy_view_cart, name='pharmacy-view-cart'),
    path('pharmacy/checkout/', views.pharmacy_checkout, name='pharmacy-checkout'),
    path('pharmacy/order-success/<str:order_number>/', views.pharmacy_order_success, name='pharmacy-order-success'),

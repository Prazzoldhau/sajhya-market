...
class Command(BaseCommand):
    help = (
        ...
        '(columns: exercise_id, description_nepali), matched by primary key. '
        'Uses the ORM so long multi-line text with quotes/apostrophes is '
        'handled safely (no manual SQL escaping).'
    )
